...
; --- EGO: Semnalizare pornita, viteza 123km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 123))

; --- OBSTACOL IN FATA: distanta 60m ---
(ag_percept (percept_pobj elem4) (percept_pname isa) (percept_pval obstacle))
(ag_percept (percept_pobj elem4) (percept_pname rel_pos) (percept_pval front))
(ag_percept (percept_pobj elem4) (percept_pname rel_dist) (percept_pval 6000))