...
; --- DRUM: Exterior (DN), linie discontinua, panta cu vizibilitate de 13m ---
...
; --- EGO: Semnalizare pornita, viteza 60km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 60))
