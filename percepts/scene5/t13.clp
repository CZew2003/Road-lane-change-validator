...
; --- DRUM: Exterior (DN), linie discontinua, panta cu vizibilitate de 3m ---
...
; --- EGO: Semnalizare pornita, viteza 56km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 56))