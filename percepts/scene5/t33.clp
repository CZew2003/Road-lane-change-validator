...
; --- EGO: Semnalizare pornita, viteza 88km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 88))

; --- ROAD ELEM: Ceata, vizibilitate 10m ---
(ag_percept (percept_pobj elem3) (percept_pname partof) (percept_pval ev))
(ag_percept (percept_pobj elem3) (percept_pname isa) (percept_pval road_nature))
(ag_percept (percept_pobj elem3) (percept_pname has_type) (percept_pval fog))
(ag_percept (percept_pobj elem3) (percept_pname has_visibility) (percept_pval 1000))
