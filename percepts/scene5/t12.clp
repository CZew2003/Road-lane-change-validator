...
; --- DRUM: Exterior (DN), Drum denivelat, linie discontinua ---
...
; --- EGO: Semnalizare pornita, viteza 64km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 64))
