...
; --- DRUM: Exterior (DN), linie discontinua, panta cu vizibilitate de 20m ---
...
(ag_percept (percept_pobj elem1) (percept_pname has_type) (percept_pval slope))
(ag_percept (percept_pobj elem3) (percept_pname rel_dist) (percept_pval 2000))

; --- EGO: Semnalizare pornita, viteza 63km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 63))


; --- MASINA SPATE: distanta 7m ---
...
(ag_percept (percept_pobj elem3) (percept_pname rel_dist) (percept_pval 700))