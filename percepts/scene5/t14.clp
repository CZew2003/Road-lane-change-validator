...
; --- DRUM: Exterior (DN), linie discontinua, panta cu vizibilitate de 5m ---
...
(ag_percept (percept_pobj elem3) (percept_pname rel_dist) (percept_pval 500))

; --- EGO: Semnalizare oprita, viteza 57km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 57))