...
(ag_percept (percept_pobj elem3) (percept_pname rel_dist) (percept_pval 910))

; --- ROAD ELEMENT: Trecere de pietoni, distanta 8.2m ---
...
(ag_percept (percept_pobj elem4) (percept_pname has_type) (percept_pval crosswalk))
(ag_percept (percept_pobj elem4) (percept_pname rel_dist) (percept_pval 8200))