...
; --- EGO: Semnalizare pornita, viteza 20km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 20))

; --- ROAD ELEM: intersectie, 2m ---
...
(ag_percept (percept_pobj elem3) (percept_pname rel_dist) (percept_pval 200))