...
; --- EGO: Semnalizare pornita, viteza 42km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 42))

; --- ROAD ELEM: intersectie, 38m ---
...
(ag_percept (percept_pobj elem3) (percept_pname has_type) (percept_pval intersection))
(ag_percept (percept_pobj elem3) (percept_pname rel_dist) (percept_pval 3800))