...
; --- EGO: Semnalizare PORNITA, viteza 49km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 49))

; --- Biciclist in spate, distanta 4.5m ---
(ag_percept (percept_pobj elem5) (percept_pname partof) (percept_pval ev))
(ag_percept (percept_pobj elem5) (percept_pname isa) (percept_pval bicycle))
(ag_percept (percept_pobj elem5) (percept_pname rel_pos) (percept_pval back))
(ag_percept (percept_pobj elem5) (percept_pname rel_dist) (percept_pval 450))