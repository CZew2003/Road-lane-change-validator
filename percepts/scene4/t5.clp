...
(ag_percept (percept_pobj elem4) (percept_pname type) (percept_pval railway_level_crossing))
(ag_percept (percept_pobj elem3) (percept_pname rel_dist) (percept_pval 7000))