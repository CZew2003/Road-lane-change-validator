...
; --- EGO: Semnalizare pornita, viteza 14km/h ---
...
(ag_percept (percept_pobj elem2) (percept_pname velocity) (percept_pval 14))

; --- ROAD ELEM: cale ferata, 4m ---
...
(ag_percept (percept_pobj elem6) (percept_pname rel_dist) (percept_pval 400))